...
export const NAVARASA_EMOTIONS: readonly NavarasaEmotion[] = [
  ...
  },
  {
    ...
    toneStrategy: 'Stay calm. Never defensive. Acknowledge their specific situation, then move immediately to action. No hollow phrases.',
    messagePattern: 'Acknowledge specific situation → Take ownership through action → Offer concrete next step → Maintain dialogue',
    doList: [
      'Acknowledge their specific situation (duration, stakes, repeated issues) - not generic empathy',
      'Take ownership through action - "Let\'s fix this" not "I apologise"',
      'Move immediately to a concrete next step',
      'Offer to DO things ("I can check", "I can arrange") not instruct them',
    ],
    dontList: [
      'Use hollow phrases like "we apologise for the inconvenience" or "we understand how frustrating"',
      'Overcompensate emotionally ("it means the world to us", "your satisfaction is important")',
      'Be defensive or make excuses',
      'Dump a checklist of troubleshooting steps',
      'End with "contact support at..." - offer to help directly instead',
    ],
    exampleResponse: "That's not the experience you should be having. Let's fix this. Tell me which city you're in so I can check for issues in your area, and I can arrange a technician visit if needed.",
  },
  {
    id: 'vira',
    name: 'Courage & Pride',
