...
// =============================================================================
// Commercial Sensitivity Agent (Phase 1.5 - From consolidatedAgents Commerce)
...
const COMMERCIAL_PATTERNS: PatternRule[] = [
  ...
  // These check for promotional keywords near support/issue keywords
...
export const commercialSensitivityAgent: ValidationAgent = {
  ...
  weight: 8, // Lower weight as it's specific to commercial contexts
...
const UX_MICROCOPY_PATTERNS: PatternRule[] = [
  ...
  // Good CTAs: "Recharge now", "View plans", "Continue", "Get help"
  // Bad CTAs: "Click here", "Submit", vague actions
  // ═══════════════════════════════════════════════════════════════════════════
  
  // Generic/vague CTA verbs (prefer action-specific verbs)
  ...
  // Good CTA patterns are enforced implicitly - warn on bad ones
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // Dead-End Detection
  // Messages that leave user without clear next action
  // ═══════════════════════════════════════════════════════════════════════════
  
  // Phrases that signal dead-ends without offering alternatives
  ...
  // Incomplete error handling (mentions issue but no resolution)
  ...
  // Contact us dead-ends (without context)
  ...
  // Good: [What happened] + [Why] + [What to do]
  // Bad: Technical jargon, blame user, no resolution
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // Error messages without clear action
  ...
  // Should guide user on how to populate / what to do
  // ═══════════════════════════════════════════════════════════════════════════
  
  // Empty/no results without guidance
  ...
  // Should confirm what happened + what's next (if any)
  // ═══════════════════════════════════════════════════════════════════════════
  
  // Success without confirmation of what succeeded
...
export const uxMicrocopyAgent: ValidationAgent = {
  ...
  calculateScore: (violations: ValidationViolation[]): number => {
    ...
    let deduction = 0;
    for (const v of violations) {
      // Dead-ends are more serious - they leave users stuck
...
} from '../../guidelines/ecosystemGlossary';

// Since glossary validation requires ecosystem context, it's handled differently.
// Pattern rules catch common misuses that don't need context.
const GLOSSARY_PATTERNS: PatternRule[] = [
  // Pack vs Plan terminology (critical)
