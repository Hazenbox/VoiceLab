        ...
        <div className="flex items-center gap-3">
          ...
          >
            <button
              ...
              className="p-1.5 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-inset"
              style={{
            ...
            {sortedAudios.map((audio) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-1"
                  style={{
                    backgroundColor: playingAudioId === audio.id ? '#f97316' : theme.background.ghost,
                    color: playingAudioId === audio.id ? 'white' : theme.text.high,
                  }}
                  aria-label={playingAudioId === audio.id ? 'Pause audio' : 'Play audio'}
                  aria-pressed={playingAudioId === audio.id}
                >
